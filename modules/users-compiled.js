...
router.get('/export2', wrap(function* (req, res, next) {
    var conf = {};
    conf.name = "mysheet1";
    conf.cols = [{ caption: 'string', type: 'string', captionStyleIndex: 1, width: 28 }, { caption: 'date', type: 'date' }, { caption: 'bool', type: 'bool' }, { caption: 'number', type: 'number' }];
    conf.rows = [['pi', new Date(2013, 4, 1).getJulian(), true, 3.14], ["e", new Date(2012, 4, 1).getJulian(), false, 2.7182]];
...
router.get('/export4', wrap(function* (req, res, next) {
    var data = [[{ "table_name": "现金报表", "date": '2014-04-09' }], [{ "cb1": "001", "cb1_": "002", "bn1": "1", "bn1_": "1", "cn1": "1", "cn1_": "1", "num1": "1", "num1_": "1",
